...
export default class extends BaseSeeder {
    evidencePool = [
        'https://images.unsplash.com/photo-1570533519183-585473489858?auto=format&fit=crop&q=80&w=600',
        ...
        'https://images.unsplash.com/photo-1563823223055-635582313318?auto=format&fit=crop&q=80&w=600',
        'https://images.unsplash.com/photo-1612450630327-1473950b91df?auto=format&fit=crop&q=80&w=600'
    ];
    async run() {
    ...
    async createTicketWithHistory(data, targetStatusId, daysAgoStart, specialNotes = {}) {
        ...
        const flow = [1, 2, 3, 5, 6, 8];
        const steps = [];
        if (targetStatusId === 7) {
            steps.push(1, 2, 3);
            if (specialNotes.wasInApproval)
                steps.push(4);
            steps.push(7);
        }
        ...
        for (const stepStatusId of steps) {
            ...
            if (isLastStep) {
                ...
                if (stepStatusId === 1)
                    custNotes = 'Recepción en tienda.';
                if (stepStatusId === 2)
                    custNotes = 'En ruta a taller central.';
                if (stepStatusId === 3)
                    custNotes = 'Iniciando diagnóstico.';
                if (stepStatusId === 4) {
                    custNotes = 'Presupuesto generado.';
                    cost = 150;
                }
                if (stepStatusId === 5)
                    techNotes = 'Reparación iniciada.';
            }
    ...
    async seedState4_PendingApproval() {
        const cases = [
...
//# sourceMappingURL=warranty_ticket_seeder.js.map